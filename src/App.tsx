...
import logo from "./assets/ayush.jpg";
import pdf from "./assets/Ayush Niraula (Resume).pdf"
const App = () => {
  return (
    <section className="bg-black relative overflow-hidden bg-no-repeat bg-center bg-cover bg-blend-mix min-h-screen">
      <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-10 md:py-16 lg:py-10">
        <div className="grid gap-12 sm:gap-20">
          <div className="flex flex-col items-start gap-4">
            ...
            <a
              href={pdf}
              download
              className="mt-6 inline-block bg-green-500 hover:bg-green-600 text-white text-base font-medium py-2 px-6 rounded-md shadow-lg transition duration-300"
            >
              Download My Resume
            </a>
            <a className="mt-3 flex items-center gap-8 text-cener text-base md:mb-10 lg:mb-4 text-white">
